...
import { createUser, emailVerification } from "../../../Services/firebase";
...
import { doesUserNameExist, createUserDoc } from "../../../Services/firebase";
import { getUserDataUid } from "../../../Services/firebase";
import { getUserDocData } from "../../../utils/store/user/userdocDataSlice";

function UserScreen({ openSnackbar, closeSnackbar, selectedType }) {
