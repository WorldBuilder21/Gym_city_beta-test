...
export default function MenuComponent({
  ...
  return (
    ...
    >
      <Menu.Items className="absolute right-2 mt-2 w-56 origin-top-right divide-y divide-slate-200 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
