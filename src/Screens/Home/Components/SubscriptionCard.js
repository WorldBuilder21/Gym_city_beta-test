          ...
          return (
            <div className="flex flex-col justify-center items-center">
              <div className="flex max-w-lg w-full flex-col shadow-md border rounded-md p-6">
                <div className="flex justify-center items-center p-2 border rounded-md text-lg bg-green-500 text-white mb-4">
                  Hiring!!!
                </div>
                ...
                <button
                  ...
                  className="border bg-zinc-700 hover:bg-zinc-800 text-white w-full p-2 rounded-md"
                >
                  Send request
                </button>
              </div>
          ...
          return (
            <div className="flex flex-col justify-center items-center">
              <div className="flex flex-col justify-center items-center text-red-500">
                <span className="text-5xl font-semibold break-all">
                  @{data?.gymname}
                </span>
                <span className="mt-2 text-lg">
                  is not actively seeking new instructors
                </span>
              </div>
            </div>
          );
        ...
        return (
          <div className="flex flex-col justify-center items-center">
            <div className="flex max-w-lg w-full flex-col shadow-md border rounded-md p-6">
              ...
              <div className="border p-4 rounded-md mb-4 mt-4">
                This is just for testing purposes in later updates gym owners
                will be able to set up their own membership subscriptions and
                fees.
              </div>
              <ul className="space-y-3">
                ...
                <span className="flex">
                  ...
                  <li className="ml-1">
                    Access to specialized workout routines
                  </li>
                </span>
                <span className="flex">
                  <svg
              ...
              <button
                onClick={handleRequest}
                className="border bg-zinc-700 hover:bg-zinc-800 text-white w-full p-2 mt-4 rounded-md"
              >
                Become a member
              </button>
            </div>
