...
export default function SkeletonFullView() {
  return (
    <div
      role="status"
      className="w-full max-w-xl animate-pulse rounded border border-gray-200 p-4 shadow dark:border-gray-700 md:p-6"
    >
      <div className="mb-4 mt-4 flex items-center space-x-3">
        <svg
